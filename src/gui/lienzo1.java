...
public class lienzo1 extends javax.swing.JPanel implements Runnable{
  ...
  private final AcomodarFichas acomodarFichas;
    ...
    Thread hilo;
    public lienzo1(AcomodarFichas acomodarFichas) {
        initComponents();
    ...
    public void run() {
        try {
            ...
            while(acomodarFichas.finish || PanelAprendizaje.banderaControl)
            {
                ...
                x=(int)(50+(Double.valueOf(acomodarFichas.getMatriz().getCoordenada().getY())*4.3));
                y=(int)(400-(Double.valueOf(acomodarFichas.getMatriz().getCoordenada().getZ())*4.3));
